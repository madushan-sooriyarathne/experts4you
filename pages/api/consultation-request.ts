...
import { sendConsultationRequestEmail } from "utils/courier";
...
export default async (
  ...
  const inquiryData: ConsultationRequestType = { ...req.body };
  ...
  const messageId = await sendConsultationRequestEmail(inquiryData);
